...
$blogPosts = [
    ...
    [
        ...
        'readTime' => '6 min read',
        'image' => 'where-to-buy-office-carpet-in-dubai/office-carpet-dubai-featured.webp'
    ],
    [
        'id' => 'what-is-vinyl-flooring.php',
        'title' => 'What is Vinyl Flooring? Complete Guide for Dubai Homes',
        'excerpt' => 'Vinyl flooring is a synthetic flooring material made primarily from PVC, designed to be durable, waterproof, and affordable. Replicating wood or stone, it\'s a popular choice for Dubai homes.',
        'date' => 'Mar 27, 2026',
        'category' => 'Flooring Guide',
        'readTime' => '7 min read'
    ],
    [
        'id' => 'what-are-pvc-folding-doors.php',
        'title' => 'What Are PVC Folding Doors? Benefits & Uses Dubai',
        'excerpt' => 'Learn what PVC folding doors are, their benefits, uses, and why they’re ideal for Dubai homes. Affordable, space-saving solutions.',
        'date' => 'Mar 26, 2026',
        'category' => 'Home Improvement',
        'readTime' => '8 min read'
    ],
    [
        'id' => 'stair-carpet-ideas-modern-homes-dubai.php',
        'title' => 'Best Stair Carpet Ideas for Modern Homes in Dubai',
        'excerpt' => 'Discover the best stair carpet ideas for modern homes in Dubai. Explore stylish designs, colors & custom options with Carpet Shop Dubai.',
        'date' => 'Mar 25, 2026',
        'category' => 'Interior Design',
        'readTime' => '10 min read'
    ],
    [
        'id' => 'stair-carpet-vs-stair-runner.php',
        'title' => 'Stair Carpet vs Stair Runner: Which One Is Better for Your Home in Dubai?',
        'excerpt' => 'Stair carpet vs stair runner – which is better in Dubai? Compare safety, cost & style. Get expert advice from Carpet Shop Dubai today.',
        'date' => 'Mar 25, 2026',
        'category' => 'Flooring Guide',
        'readTime' => '10 min read'
    ],
    [
        'id' => 'where-to-buy-wall-to-wall-carpet-dubai.php',
        'title' => 'Where to Buy Wall to Wall Carpet in Dubai',
        'excerpt' => 'Looking to buy wall to wall carpet in Dubai? Explore prices, expert tips & trusted suppliers like Carpet Shop Dubai. Call or WhatsApp now!',
        'date' => 'Mar 20, 2026',
        'category' => 'Flooring Guide',
        'readTime' => '8 min read'
    ],
    [
        'id' => 'where-to-buy-spc-flooring-dubai.php',
        'title' => 'Where to Buy SPC Flooring in Dubai',
        'excerpt' => 'Looking to buy SPC flooring in Dubai? Discover prices, expert tips & trusted suppliers like Carpet Shop Dubai. Check out our detailed cost guide.',
        'date' => 'Mar 19, 2026',
        'category' => 'Flooring Guide',
        'readTime' => '7 min read'
    ],
    [
        'id' => 'which-stair-carpet-is-best-for-your-home-in-dubai.php',
        'title' => 'Which Stair Carpet is Best for Your Home in Dubai?',
        'excerpt' => 'Discover which stair carpet is best for your home in Dubai. Learn about top materials, safety features, and design tips for a perfect staircase.',
        'date' => 'Mar 19, 2026',
        'category' => 'Shopping Guide',
        'readTime' => '8 min read'
    ],
    [
        'id' => 'where-to-buy-stair-carpets-in-dubai-online.php',
        'title' => 'Where to Buy Stair Carpets in Dubai Online',
        'excerpt' => 'Find out where to buy stair carpets in Dubai online. Custom designs, professional measurement, and installation services for a perfect fit and safe finish.',
        'date' => 'Mar 19, 2026',
        'category' => 'Shopping Guide',
        'readTime' => '6 min read'
    ],
    ...
    [
        'id' => 'professtional-carpet-stitching-Dubai.php',
    ...
    [
        'id' => 'Luxury-Carpet-Tiles-Dubai.php',
    ...
    [
        'id' => 'custom-stair-carpet-dubai.php',
                    ...
                    <article class="blog-card">
                        <div class="blog-card-image">
                            <?php if (!empty($post['image'])): ?>
                                <img src="<?php echo $post['image']; ?>" alt="<?php echo $post['title']; ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <?php echo $post['title']; ?>
                            <?php endif; ?>
                        </div>
                        <div class="blog-card-content">
                            ...
                            <a class="read-more" href="<?php echo $post['id']; ?>">Read More →</a>
                        </div>
                    </article>
                <?php endforeach; ?>
